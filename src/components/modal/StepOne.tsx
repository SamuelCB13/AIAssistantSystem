        ...
        <article className="grid grid-cols-1 md:grid-cols-3 items-center gap-5">
            ...
            <div className="w-full col-span-3">
                ...
                <textarea
                    ...
                    className="w-full rounded-lg border border-neutral-700 px-3 py-2 text-white focus:border-primary focus:outline-none transition-all duration-200 hover:border-neutral-500 resize-none h-24"></textarea>
            </div>
        </article>
    )
}
